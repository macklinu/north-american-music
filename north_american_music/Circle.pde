class Circle {
  ...
  void animate() {
    firstAni = new Ani(this, toSeconds(firstTime) / 30, "radius", dist(start.epiX, start.epiY, first.epiX, first.epiY), Ani.LINEAR, "onEnd:nextAni");
    // firstAni.start();
  }
  ...
  private void nextAni() {
    ...
    secondAni = new Ani(this, toSeconds(secondTime - firstTime) / 30, "radius", dist(start.epiX, start.epiY, second.epiX, second.epiY), Ani.LINEAR, "onEnd:finishAni");
    secondAni.start();
  }
